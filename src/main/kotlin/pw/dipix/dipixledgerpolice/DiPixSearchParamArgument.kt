...
import com.github.quiltservertools.ledger.commands.parameters.*
 ...
 * Limits radius
 */
object DiPixSearchParamArgument {
    ...
    fun get(input: String, source: ServerCommandSource): ActionSearchParams {
        ...
        for (entry in result.entries()) {
            ...
            when (param) {
                "range" -> {
                    // HERE IS THE EDIT!!!
                    val range = min(value as Int - 1, config[DipixLedgerPoliceConfig.searchMaxRange])
